...
from app.views import all_user, login_user, change_password, register, chart_coffee, chart_coffee_details, addMoney, withdrawalMoney, getMoney
...
urlpatterns = [
	...
	path('getMoney', getMoney, name='getMoney'),
]
